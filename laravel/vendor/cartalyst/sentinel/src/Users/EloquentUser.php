...
class EloquentUser extends Model implements RoleableInterface, PermissibleInterface, PersistableInterface, UserInterface
{
    ...
    {
        return $this->belongsTo('App\College_name','id');
    }
    ...
    {
        return $this->hasMany('App\Conversation','user_id2');
    }
    ...
    {
        return $this->hasMany('App\Message','user_id2');
    }
     ...
     * @var array
     */
    protected $loginNames = ['username', 'college_id' , 'phone', 'University_id'];
